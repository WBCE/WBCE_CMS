...
if ($search_normal_string != '') {
    ...
    if ($cfg_enable_old_search) {
        // this is the old (wb <= 2.6.7) search-function
        ...
        foreach ($sorted_modules as $module) {
            ...
            if ($get_query_body->numRows() > 0) {
                ...
                // on error, skip the rest of the current loop iteration
                ...
                if ($page_query->numRows() > 0) {
                    while ($page = $page_query->fetchRow()) {
                        ...
                        if (!isset($page['modified_when'])) {
                            $page['modified_when'] = 0;
                        }
                        if (!isset($page['modified_by'])) {
                            $page['modified_by'] = 0;
                        }

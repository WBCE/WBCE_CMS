                ...
                <tr>
                    <td style="width:26px; {padding_left}">
                        <?php if ($expandable == true): ?>
                            <a href="javascript: toggle_visibility('p{PAGE_ID}');"
                               title="<?php echo $plus_minusTitle; ?>"><img
                                        src="{THEME_ICONS}/<?php echo $plus_minusIcon; ?>.png"
                                        onclick="toggle_plus_minus('{PAGE_ID}');" name="plus_minus_{PAGE_ID}" border="0"
                                        alt="<?php echo $plus_minusAlt; ?>"/></a>
                        <?php else: ?>
                                    ...
                                    if ($len != null && $len != 0): ?>
                                        <a href="../pages/modify.php?page_id={PAGE_ID}&status=workingcopy"
                                           title="<?php echo "Working-Copy"; ?>">
                                            <small><img src="{THEME_ICONS}/wysiwyg_copy_16.png" border="0"
                                                        alt="[<?php echo "Working-Copy"; ?>]"/></small>
                                        </a>
                                    <?php endif;
                                endif;
                            else: ?>
                        ...
                        <div style="background-color:#FDFEFF; border:1px solid #869F6D;margin:1px;padding-bottom:2px;text-align:center; white-space:nowrap;">
                            <small>
                                <?php if ($canModifyPage) : ?>
                                    <a href="{modifyPageURL}" title="<?php echo $HEADING['MODIFY_PAGE']; ?>"><img
                                                src="{THEME_ICONS}/modify_16.png" border="0"
                                                alt="[<?php echo $TEXT['MODIFY']; ?>]"/></a>
                                <?php else: ?>
                                    <img src="{THEME_ICONS}/empty.png" border="0" alt=""/>
                                <?php endif; //$canModifyPage
                                ...
                                if ($p['visibility'] != 'deleted') : ?>
                                    <?php if ($canModifySettings) : ?>
                                        <a href="{modifySettingsURL}"
                                           title="<?php echo $HEADING['MODIFY_PAGE_SETTINGS']; ?>"><img
                                                    src="{THEME_ICONS}/options_16.png" border="0"
                                                    alt="[<?php echo $TEXT['SETTINGS']; ?>]"/></a>
                                    <?php else: ?>
                                        <img src="{THEME_ICONS}/empty.png" border="0" alt=""/>
                                    <?php endif; //$canModifySettings?
                                elseif ($p['visibility'] == 'deleted') :?>
                                    <a href="{restoreURL}" title="<?php echo $TEXT['RESTORE']; ?>"><img
                                                src="{THEME_ICONS}/restore_16.png" border="0"
                                                alt="[<?php echo $TEXT['RESTORE']; ?>]"/></a>
                                <?php else: ?>
                                    <img src="{THEME_ICONS}/empty.png" border="0" alt=""/>
                                ...
                                if (isset($menu_link) && $menu_link == true):?>
                                    <img src="{THEME_ICONS}/menu_link.png" border="0" alt="[menu-link]"
                                         title="Menu Link" style="cursor:default;"/>
                                <?php
                                elseif ($canManageSections): ?>
                                    <a href="<?php echo $sectionsURL; ?>"
                                       title="<?php echo $HEADING['MANAGE_SECTIONS']; ?>"><img
                                                src="{THEME_ICONS}/{section_icon}" border="0"
                                                alt="[<?php echo $HEADING['MANAGE_SECTIONS']; ?>]"/></a>
                                <?php else: ?>
                                    <img src="{THEME_ICONS}/empty.png" border="0" alt=""/>
                                <?php endif; ?>
                            </small>
                        ...
                        <small>
                            <nobr>&nbsp;
                                <?php if ($p['visibility'] != 'deleted' && $p['visibility'] != 'none') : ?>
                                    <a href="{frontendViewURL}" target="_blank"
                                       title="<?php echo $TEXT['VIEW']; ?> (Frontend)"><img
                                                src="{THEME_ICONS}/view_16.png" border="0"
                                                alt="[<?php echo $TEXT['VIEW']; ?>]"/></a>
                                <?php else: ?>
                                    <img src="{THEME_ICONS}/empty.png" border="0" alt=""/>
                    ...
                    <td class="list_actions">&nbsp;
                        <?php if ($canMoveUP) : ?>
                            <a href="../pages/move_up.php?page_id={PAGE_ID}"
                               title="<?php echo $TEXT['MOVE_UP']; ?>"><img src="{THEME_ICONS}/up_16.png" border="0"
                                                                            alt="/\"/></a>
                        <?php endif; //$canMoveUP?>
                    </td>
                    <td class="list_actions">
                        <?php if ($canMoveDOWN) : ?>
                            <a href="../pages/move_down.php?page_id={PAGE_ID}"
                               title="<?php echo $TEXT['MOVE_DOWN']; ?>"><img src="{THEME_ICONS}/down_16.png" border="0"
                                                                              alt="\/"/></a>
                        <?php endif; //$canMoveDOWN?>
                    </td>
                    <td class="list_actions">
                        <?php if ($canDeleteAndModify) : ?>
                            <a href="javascript:confirm_link('PageID: {PAGE_ID}\n\n\t<?php echo $MESSAGE['PAGES_DELETE_CONFIRM']; ?>?','../pages/delete.php?page_id={pageIDKEY}');"
                               title="<?php echo $TEXT['DELETE']; ?>"><img src="{THEME_ICONS}/delete_16.png" border="0"
                                                                           alt="[x]"/></a>
                        <?php else: ?>
                            <img src="{THEME_ICONS}/empty.png" border="0" alt=""/>
                    ...
                    <td class="list_actions">
                        <?php if ($canAddChild) : ?>
                            <a href="javascript:add_child_page('{PAGE_ID}');"
                               title="<?php echo $HEADING['ADD_CHILD_PAGE']; ?>"><img src="{THEME_ICONS}/add_child.png"
                                                                                      name="addpage_{PAGE_ID}"
                                                                                      border="0" alt="[+]"/></a>
...
<div class="pages_list" style="margin: 4px; padding: 4px; border: solid 2px #d5dde7 !important">
    <table cellspacing="0" cellpadding="0" border="0"
           <?php if (empty($pages_list)): ?>style="display:none;"<?php endif; ?>>
        <tbody>
        <tr>
            <td style="width:330px;padding:3px"><small><?php echo $TEXT['VISIBILITY']; ?></small>
                / <?php echo $TEXT['MENU_TITLE']; ?>:
            </td>
            <td style="text-align:left;width:330px;"><code> &lt;title&gt;</code> (<?php echo $TEXT['PAGE_TITLE']; ?>):
            </td>
	...
	<button style="width:140px;" title="Drag&amp;Drop"
            onclick="javascript:window.location='<?php echo(ADMIN_URL); ?>/pages/page_tree/activate_dragdrop.php?<?php echo '&dd=' . $set_dd; ?>';">

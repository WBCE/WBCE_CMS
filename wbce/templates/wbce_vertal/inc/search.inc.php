...
<div role="search" id="search_box">			
	...
	<input type="text" value="<?php if (isset($_GET['string'])) {echo htmlspecialchars($_GET['string']);} else {echo $TEXT['SEARCH']; } ?>" id="searchstring" name="string" class="searchstring" onfocus="if (this.value=='<?php echo $TEXT['SEARCH']; ?>') {this.value='';}" />
	</label>

...
(function () {
	...
	var // jQuery and jQueryUI version
		...
		start = function (elFinder, editors, config) {
			// load jQueryUI CSS
			elFinder.prototype.loadCss('./../../include/jquery/jquery-ui.min.css');
		...
		load = function () {
			require(
				[
					'elfinder', './../../../modules/elfinder/ef/js/extras/editors.default.min' // load text, image editors
					, 'elFinderConfig'
	...
	require.config({
		baseUrl: 'js',
		paths: {
			'jquery': './../../../include/jquery/jquery-min',
			'jquery-ui': './../../../include/jquery/jquery-ui-min',
			'elfinder': './../../../modules/elfinder/ef/js/elfinder.min',
			'encoding-japanese': './../../../modules/elfinder/ef/js/encoding.min'
		},
	...
	if (!require.defined('elFinderConfig')) {
		define('elFinderConfig', {
			...
			defaultOpts: {
				url: './../../../modules/elfinder/ef/php/connector.wbce.php' // connector URL (REQUIRED)
					,
				commandsOptions: {
					edit: {
						extraOptions: {

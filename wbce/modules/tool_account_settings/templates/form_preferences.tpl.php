...
<div class="cpForm">
	<form name="details" action="" method="post">
		...
		<div class="formRow">
			...
			<div class="settingValue">
				<select name="timezone" id="timezone">
					<option value="-20"><?=$TOOL_TXT['PLEASE_SELECT'] ?></option>
		...
		<div class="formRow">
			...
			<div class="settingValue">
				<select id="date_format" name="date_format">
					<option value=""><?=$TOOL_TXT['PLEASE_SELECT'] ?></option>
		...
		<div class="buttonsRow">
			...
			<button type="submit" name="action" value="details" class="button" ><?=$TOOL_TXT['SAVE_SETTINGS'] ?></button>
		</div>
	</form>
	<form name="email" action="" method="post">
		...
		<div class="buttonsRow">
			<button type="reset" name="reset" value="reset" class="button" ><?=$TEXT['RESET'] ?></button>
			<button type="submit" name="action" value="email" class="button" ><?=$TOOL_TXT['SAVE_EMAIL'] ?></button>
		</div>
	</form>
	...
	<form name="password" action="" method="post">
		...
		<div class="buttonsRow">
			<button type="reset" name="reset" value="reset" class="button" ><?=$TEXT['RESET'] ?></button>
			<button type="submit" name="action" value="details" class="button" ><?=$TOOL_TXT['SAVE_PASSWORD'] ?></button>
		</div>
	</form>

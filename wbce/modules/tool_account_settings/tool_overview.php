...
$pluginsUrl = get_url_from_path(__DIR__).'/js';

I::insertCssFile($pluginsUrl."/jquery.tablesorter/theme.wbEasy.css",                    "HEAD BTM-");
I::insertJsFile( $pluginsUrl."/jquery.tablesorter/jquery.tablesorter.js",               "HEAD BTM-");
I::insertJsFile( $pluginsUrl."/jquery.tablesorter/jquery.tablesorter.widgets.js",       "HEAD BTM-");
I::insertJsFile( $pluginsUrl."/jquery.tablesorter/tablesorter_accout_tool_settings.js", "BODY BTM-");
$sToCss = "
...
// show all users?
$users = $oAccounts->getUsersOverview();
#debug_dump($aUsers);
if(!empty($users)){
    ...
    $aToTwig = array(
        ...
        'USERLIST'            => $oAccounts->getUsersOverview(),
        'GET'                 => $_GET
    );    

...
class counter
{
    ...
    public function init()
    {
        ...
        if (!$id) {
            $database->query("INSERT INTO ".$table_day." (day, user, view) values ('".$this->day."', '0', '0')");
        }
    }
    ...
    public function getKeywords()
    {
        ...
        } elseif (isset($parms['q'])) {
            $this->keywords = 'Searchkey not provided';
    ...
    public function isBot()
    {
        ...
        if (empty($userAgent)) {
            return true;
        } //Empty useraget is mostly a bot

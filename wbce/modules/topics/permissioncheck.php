...
//$authorsgroup: Die Gruppe, der Autoren angeh�ren. 
...
if ($authorsgroup > 0) { //Care about users	
	if (in_array($authorsgroup, $user_in_groups)) {
		...
		$author_trust_rating = 0; //Best Trust; Flag aus module_settings.php wird zur�ckgesetzt
	}
}
...
//Hier k�nnte man abw�rgen, dass ein Autor ins Backend kommt. 

...
function show_wysiwyg_editor($name, $id, $content, $width = '100%', $height = '350px', $toolbar = false) {
    ...
    /* Create new CKeditor instance. But first - we've got to revamp this pretty old class a little bit. */
    ...
    $ckeditor->resolve_path('contentsCss', $tplPath . '/wb_config/editor.css', $ModPath . '/ckeditor/contents.css');
    
    /* Looking for the editor.styles at all ... */
    $ckeditor->resolve_path('stylesSet', $tplPath . '/wb_config/editor.styles.js', $ModPath . '/ckeditor/styles.js', 'wb:');

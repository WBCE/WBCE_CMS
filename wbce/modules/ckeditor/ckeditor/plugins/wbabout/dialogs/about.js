						...
						html :
							'<style type="text/css">' +
								...
								'{' +
									...
									'margin-bottom:10px;' +
								'}' +
								'.cke_about_container .wb-logo' +
								'{' +
									'height:81px;' +
									'background-color:#fff;' +
									'background-image:url(' + CKEDITOR.plugins.get( 'about' ).path + 'dialogs/wb-logo.gif);' +
									'background-position:center; ' +
									'background-repeat:no-repeat;' +
									'margin-bottom:10px;' +
								'}' +
							...
							'<div class="cke_about_container">' +
								...
								'<p>' +
									lang.wbmoduleinfo  + lang.modulversion + CKEDITOR.wbversion+'<br />' +
									'<a href="http://www.websitebaker2.org/">http://www.websitebaker2.org/</a>' +
								'</p>' +
								'<p>' +
									lang.help.replace( '$1', '<a href="http://www.websitebaker2.org/de/hilfe/hilfe-projekt.php">' + lang.wbuserGuide + '</a>' ) +
								'</p>' +
								'<p>' +
									lang.wbmoreInfo +
								...
								'</p>' +
								'<p>' +
									lang.copy.replace( '$1', '<a href="http://www.websitebaker2.org/en/organisation/the-association.php">WebsiteBaker Project</a> - WebsiteBaker Org e.V.' ) +
								'</p>' +
							'</div>'
					}
				]

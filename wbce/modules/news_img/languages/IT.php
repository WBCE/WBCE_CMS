...
$MOD_NEWS_IMG['ADD_TAG'] = 'Aggiungi tag'; 
$MOD_NEWS_IMG['ADVANCED_SETTINGS'] = 'Impostazioni avanzate'; 
$MOD_NEWS_IMG['ALL'] = "Tutto";
$MOD_NEWS_IMG['ASSIGN_GROUP'] = "Assegna gruppo"; 
$MOD_NEWS_IMG['ASSIGN_TAGS'] = "Assegna tag"; 
$MOD_NEWS_IMG['CLEAR_PUBLISHED_UNTIL'] = "cancella data di scadenza";
$MOD_NEWS_IMG['CLEAR_PUBLISHED_WHEN'] = "reimposta data di pubblicazione";
$MOD_NEWS_IMG['CONTINUE'] = "Successivo";
$MOD_NEWS_IMG['COPY'] = "copia";
$MOD_NEWS_IMG['COPY_WITH_TAGS'] = 'copia (incl. tag)'; 
$MOD_NEWS_IMG['COPY_POST'] = 'Copia post';
$MOD_NEWS_IMG['CURRENT_SECTION'] = 'Sezione corrente'; 
...
$MOD_NEWS_IMG['GLOBAL'] = 'Tag globale'; 
$MOD_NEWS_IMG['GOBACK'] = 'Indietro';
$MOD_NEWS_IMG['GROUP'] = 'Gruppo'; 
$MOD_NEWS_IMG['GROUPS'] = 'Gruppi'; 
...
$MOD_NEWS_IMG['INFO_GLOBAL'] = "I tag globali possono essere utilizzati in tutte le sezioni di notizie con immagini."; 
$MOD_NEWS_IMG['INFO_RELOAD_PAGE'] = "Questo ricaricherà la pagina; tutti i dati non salvati andranno persi!"; 
...
$MOD_NEWS_IMG['MOVE_WITH_TAGS'] = 'sposta (incl. tag)'; 
$MOD_NEWS_IMG['NEW_POST'] = 'Crea nuovo post';
$MOD_NEWS_IMG['NEWEST_FIRST'] = 'il più recente in alto'; 
...
$MOD_NEWS_IMG['POST_ACTIVE'] = 'Il messaggio è visibile'; 
$MOD_NEWS_IMG['POST_CONTENT'] = 'Pubblica contenuto';
$MOD_NEWS_IMG['POST_INACTIVE'] = 'Il messaggio non è visibile'; 
$MOD_NEWS_IMG['POST_SETTINGS'] = 'Impostazioni post';
$MOD_NEWS_IMG['POSTED_BY'] = 'Inserito da'; 
$MOD_NEWS_IMG['POSTS'] = 'Messaggi'; 
...
$MOD_NEWS_IMG['SHOW_SETTINGS_ONLY_ADMINS'] = 'Le impostazioni possono essere visualizzate/modificate solo dagli amministratori'; 
$MOD_NEWS_IMG['TAG'] = 'tag';
$MOD_NEWS_IMG['TAG_COLOR'] = 'Colore tag'; 
$MOD_NEWS_IMG['TAG_EXISTS'] = 'Il tag esiste'; 
$MOD_NEWS_IMG['TAGS'] = 'tag'; 
$MOD_NEWS_IMG['TAGS_INFO'] = 'Per utilizzare i tag, modifica un post e seleziona lì i tag desiderati.'; 
$MOD_NEWS_IMG['TO'] = "a";
$MOD_NEWS_IMG['UPLOAD'] = 'Carica'; 
$MOD_NEWS_IMG['USE_SECOND_BLOCK'] = 'Usa il secondo blocco'; 
$MOD_NEWS_IMG['USE_SECOND_BLOCK_HINT'] = 'Deve essere supportato dal modello'; 
$MOD_NEWS_IMG['VIEW'] = 'Presentazione/Visualizzazione'; 
$MOD_NEWS_IMG['VIEW_INFO'] = "Dopo aver modificato l'impostazione, premi Salva; i markup per il loop dei post e la visualizzazione dei dettagli dei post verranno regolati automaticamente.";

// Impostazioni dell'immagine
$MOD_NEWS_IMG['CROP'] = 'Ritaglia';
$MOD_NEWS_IMG['GALLERY'] = 'Galleria immagini';
$MOD_NEWS_IMG['GALLERY_INFO'] = "Dopo aver modificato l'impostazione della galleria, premi save; il markup per il loop dell'immagine verr&agrave;Â  regolato automaticamente. ";

...
$MOD_NEWS_IMG['ADD_TAG'] = 'Ajouter un mot clÃ©';
$MOD_NEWS_IMG['ADVANCED_SETTINGS'] = 'Paramètres avancés';
$MOD_NEWS_IMG['ALL'] = "Tous";
$MOD_NEWS_IMG['ASSIGN_GROUP'] = "Attribuer un groupe";
$MOD_NEWS_IMG['ASSIGN_TAGS'] = "Attribuer des balises"; 
$MOD_NEWS_IMG['CLEAR_PUBLISHED_UNTIL'] = "effacer la date d'expiration" ;
$MOD_NEWS_IMG['CLEAR_PUBLISHED_WHEN'] = "réinitialiser la date de publication";
$MOD_NEWS_IMG['CONTINUE'] = "Suivant";
$MOD_NEWS_IMG['COPY'] = "copier";
$MOD_NEWS_IMG['COPY_WITH_TAGS'] = 'copie (y compris les balises)';
$MOD_NEWS_IMG['COPY_POST'] = 'Copier le message';
$MOD_NEWS_IMG['CURRENT_SECTION'] = 'Section actuelle';
...
$MOD_NEWS_IMG['GLOBAL'] = 'Mot clÃ© global';
$MOD_NEWS_IMG['GOBACK'] = 'Retour';
$MOD_NEWS_IMG['GROUP'] = 'Groupe';
$MOD_NEWS_IMG['GROUPS'] = 'Groupes';
...
$MOD_NEWS_IMG['INFO_GLOBAL'] = "Les mots clÃ©s globaux s'appliquent Ã  toutes les sections.";
$MOD_NEWS_IMG['INFO_RELOAD_PAGE'] = "La page se recharge; toutes les modifications non enregistrÃ©es seront perdues!";
...
$MOD_NEWS_IMG['MOVE_WITH_TAGS'] = 'déplacer (y compris les balises)';
$MOD_NEWS_IMG['NEW_POST'] = 'Cr&eacute;er un nouveau message';
$MOD_NEWS_IMG['NEWEST_FIRST'] = 'le plus récent en haut';
...
$MOD_NEWS_IMG['POST_ACTIVE'] = 'La publication est visible';
$MOD_NEWS_IMG['POST_CONTENT'] = 'Publier du contenu';
$MOD_NEWS_IMG['POST_INACTIVE'] = "La publication n'est pas visible";
$MOD_NEWS_IMG['POST_SETTINGS'] = 'Param&egrave;tres postaux';
$MOD_NEWS_IMG['POSTED_BY'] = 'Publié par';
$MOD_NEWS_IMG['POSTS'] = 'Messages';
...
$MOD_NEWS_IMG['SHOW_SETTINGS_ONLY_ADMINS'] = 'Param&egrave;tres seulement pour administrateurs';
$MOD_NEWS_IMG['TAG'] = 'Balise'; 
$MOD_NEWS_IMG['TAG_COLOR'] = 'Couleur de balise';
$MOD_NEWS_IMG['TAG_EXISTS'] = 'Balise existe'; 
$MOD_NEWS_IMG['TAGS'] = 'Balises'; 
$MOD_NEWS_IMG['TAGS_INFO'] = 'Pour utiliser des mots clÃ©s, modifiez une publication et sÃ©lectionnez les mots clÃ©s souhaitÃ©s.';
$MOD_NEWS_IMG['TO'] = "&agrave;";
$MOD_NEWS_IMG['UPLOAD'] = 'Télécharger une nouvelle image';
$MOD_NEWS_IMG['USE_SECOND_BLOCK'] = 'Utiliser le deuxième bloc';
$MOD_NEWS_IMG['USE_SECOND_BLOCK_HINT'] = 'Doit être pris en charge par le modèle';
$MOD_NEWS_IMG['VIEW'] = 'Présentation / Vue';
...
$MOD_NEWS_IMG['PAGE_NOT_FOUND'] = 'Page non trouvÃ©e';
...
$MOD_NEWS_IMG['TEXT_NEXT_POST'] = 'PrÃ³ximo post';
$MOD_NEWS_IMG['TEXT_O_CLOCK'] = 'horas';
$MOD_NEWS_IMG['TEXT_ON'] = '&agrave;';
$MOD_NEWS_IMG['TEXT_POSTED_BY'] = 'Publi&eacute; par';
$MOD_NEWS_IMG['TEXT_PREV_POST'] = 'En savoir plus';
$MOD_NEWS_IMG['TEXT_READ_MORE'] = 'Consulte mais informaÃ§Ã£o';
$MOD_NEWS_IMG['TEXT_RESET'] = 'Redefinir';
$MOD_NEWS_IMG['TO'] = 'para';
$MOD_NEWS_IMG['IMPORT'] = 'importer';

...
<ul id="p<?php echo $parent; ?>" <?php if($parent != 0) { echo 'class="page_list"'; } ?>>
 ...
 <li id="p<?php echo $page['parent']; ?>" style="padding: 2px 0px 2px 0px;">
  <table width="720" cellpadding="1" cellspacing="0" border="0" style="background-color: #F0F0F0;">
   <tr>
    <td width="20" style="padding-left: <?php echo $page['level']*20; ?>px;"><?php
					if($display_plus == true) {
					?>
     <a href="javascript: toggle_visibility('p<?php echo $page['page_id']; ?>');" title="<?php echo $TEXT['EXPAND'].'/'.$TEXT['COLLAPSE']; ?>"> <img src="<?php echo THEME_URL; ?>/images/minus_16.png" onclick="toggle_plus_minus('<?php echo $page['page_id']; ?>');" name="plus_minus_<?php echo $page['page_id']; ?>" border="0" alt="+" /> </a>
     <?php
					}
					?></td>
    <?php if($admin->get_permission('pages_modify') == true AND $can_modify == true) { ?>
    <td><a href="<?php echo WB_URL; ?>/modules/pagecloner/tool_clone.php?pagetoclone=<?php echo $page['page_id']; ?>" title="<?php echo $PCTEXT['CLONE_PAGE']; ?>"><?php echo ($page['page_title']); ?></a></td>
    <?php } else { ?>
    <td><?php	echo ($page['page_title']); ?></td>
    <?php } ?>
    <td align="left" width="375"><span style="color: #999999; "><?php echo ($page['menu_title']); ?></span></td>
    <td align="center" valign="middle" width="130"><?php if($page['visibility'] == 'public') { ?>
     ...
     <img src="<?php echo THEME_URL; ?>/images/hidden_16.png" alt="<?php echo $TEXT['VISIBILITY']; ?>: <?php echo $TEXT['HIDDEN']; ?>" border="0" />
     <?php } elseif($page['visibility'] == 'none') { ?>
     <img src="<?php echo THEME_URL; ?>/images/none_16.png" alt="<?php echo $TEXT['VISIBILITY']; ?>: <?php echo $TEXT['NONE']; ?>" border="0" />
...
<table cellpadding="0" cellspacing="0" width="100%" border="0">
 <tr>
  <td><h2><?php echo $PCTEXT['CHOOSE_PAGE']; ?></h2></td>
  <td align="right"><?php
    ...
    if(PAGE_TRASH == 'separate') {
        ...
        if($query_trash->numRows() > 0) {
            ?>
   <a href="<?php echo ADMIN_URL; ?>/pages/trash.php"> <img src="<?php echo THEME_URL; ?>/images/delete_16.png" alt="<?php echo $TEXT['PAGE_TRASH']; ?>" border="0" /> <?php echo $TEXT['VIEW_DELETED_PAGES']; ?></a>
   <?php
        }
    }
?></td>
...
<div class="pages_list">
 <table cellpadding="1" cellspacing="0" width="720" border="0">
  <tr>
   <td width="20">&nbsp;</td>
   <td><?php echo $TEXT['PAGE_TITLE']; ?>: </td>
   <td width="375" align="left"><?php echo $TEXT['MENU_TITLE']; ?>: </td>
   <td width="130" align="right"><?php echo $TEXT['VISIBILITY']; ?>: </td>
  </tr>
 </table>
 <?php
...
<div class="empty_list"> <?php echo $TEXT['NONE_FOUND']; ?> </div>
<?php
} else {
	$editable_pages = 0;
}

...
if(file_exists(WB_PATH.'/modules/miniform/new_frontend.css')) {
	...
	if(isset($_GET['unlink'])) {
		...
		echo '<br>Otherwise <a href="'.$url.'&unlink=1">remove the file new_frontend.css</a></h6>';
	}
}
$mform = new mForm();
$d = 0;
...
<form action="<?php echo WB_URL ?>/modules/miniform/save.php" method="post"  >
	...
	<table class="settable" id="mfsettings-<?php echo $section_id ?>" cellpadding="3" cellspacing="3" border="0">
		<tr><td colspan="2"><h2><?php echo $MF['MINIFORM'] ?> - <?php echo $MF['SETTINGS'] ?></h2></td><td><a style="float:right" href="#" class="recved mf-button"><?php echo $MF['HISTORY'] ?></a></td></tr>
		...
		<tr><td><?php echo $MF['TEXT_SUCCESS'] ?>: </td><td>		
				<select  class="mf-input wide" name="successpage" style="font-family:monospace;" />
...
?>
<table class='msgtable' cellpadding="3" border="0" style="margin-top:25px;">

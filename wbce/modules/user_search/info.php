...
$module_author = 'Bernd Michna, Aldus, Bramus, Quinto, marmot, florian, Colinax';
 ...
 * Version history
 *
 *  v0.51 (Colinax; 24.05.2017)
 *        - User Search uses now Theme icons and not longer Admin icons
 ...
 *        - some source code refining and added some little thing to help in the future for example to allow to store the search.

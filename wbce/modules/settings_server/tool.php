...
if($saveSettings) {
    ...
    $setError.=Settings::Set ("rename_files_on_upload", 'ph.*?,cgi,pl,pm,exe,com,bat,pif,cmd,src,asp,aspx,js');    
    $setError.=Settings::Set ("wb_rename_files_on_upload", 'ph.*?,cgi,pl,pm,exe,com,bat,pif,cmd,src,asp,aspx,js');    
    $setError.=Settings::Set ("wb_deny_files_on_upload", 'ph.*?,cgi,pl,pm,exe,com,bat,pif,cmd,src,asp,aspx,js'); 

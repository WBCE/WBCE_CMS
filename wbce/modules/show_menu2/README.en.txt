Show_Menu2
====================
A code snippet for the WBCE CMS. It provides a complete 
...
There are many more possible menus that can be generated by show_menu2.
See the demonstration website at https://sm2.wbce-cms.org/ for more examples
...
$aStart  
    ...
    following values:
        ...
        page_id     Display using the specific page as the parent. All
                    ...
                    page_id can be found by editing the page in admin 
...
$aOptions  
    ...
    SM2_ESCAPE      Call htmlspecialchars on the menu strings. This may be
                    required with older installations. By escaping the

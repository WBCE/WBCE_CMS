...
A:  https://addons.wbce.org/pages/addons.php?do=item&item=3
...
Jeder Parameter muss absolut korrekt verwendet werden. Folgende Regeln können 
dabei helfen:

    $aMenu = 0 ist in den meisten Anwendungsfällen der beste Wert.
    
    $aStart muss entweder eine page ID oder ein Wert der mit "SM2_" beginnt sein.

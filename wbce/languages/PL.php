...
$TEXT['FILE_MODE'] = 'Tryb plików';
$TEXT['FINISH_PUBLISHING'] = 'Zakoncz publikowanie';
$TEXT['FOLDER'] = 'folder';
$TEXT['FOLDERS'] = 'foldery';
$TEXT['FOOTER'] = 'Stopka';
$TEXT['FORGOTTEN_DETAILS'] = 'Zapomniałes(-as) hasła?';
$TEXT['FORGOT_DETAILS'] = 'Zapomniałes(-as) szczegółów?';
$TEXT['FROM'] = 'Od';
...
$TEXT['INSTALLED'] = 'zainstalowane';
$TEXT['INTRO'] = 'Intro';
$TEXT['INTRO_PAGE'] = 'Strona wprowadzajaca';
$TEXT['INVALID_SIGNS'] = 'musi zaczynac się od litery badz niedozwolonych znaków';
$TEXT['KEYWORDS'] = 'slow kluczowe';
$TEXT['LANGUAGE'] = 'Język';
$TEXT['LAST_UPDATED_BY'] = 'Ostatnio zmienione przez';
$TEXT['LENGTH'] = 'Dlugość';
$TEXT['LEVEL'] = 'Poziom';
$TEXT['LINK'] = 'Odnośnik (link)';
...
$TEXT['MAX_SUBMISSIONS_PER_HOUR'] = 'Maksymalna ilość zgłoszeń na godzinę';
...
$TEXT['NOT_INSTALLED'] = 'nie zainstalowane';
...
$TEXT['POST_HEADER'] = 'Naglówek wiadomości';
...
$TEXT['RELOAD'] = 'Przeładuj, odswież';
$TEXT['REMEMBER_ME'] = 'Zapamietaj mnie';
$TEXT['RENAME'] = 'Zmień nazwe';
...
$TEXT['USERS_DELETED'] = 'Użytkownicy usunieci';
$TEXT['USERS_FLAGS'] = 'Flagi użytkowników';
$TEXT['USERS_PROFILE_ALLOWED'] = 'Użytkownik może tworzyc profil rozszerzony';
...
$TEXT['WBMAILER_DEFAULT_SETTINGS_NOTICE'] = 'Określ domyślny adres odbiorcy "FROM" i nadawcy "SENDER". Zaleca się stosowanie ODBIORCY tak jak na przykladzie: <strong>admin@yourdomain.com</strong>. Niektórzy dostawcy maili (np. <em>mail.com</em>) moga odrzucic maile od ODBIORCY adresu takiego jak np <em>name@mail.com</em> ze wzgledu na potraktowanie tego jako spam.<br /><br /> Wartości domyślne sa używane tylko wtedy inne wartości sa określone przez WBCE CMS. Jesli twój serwer obsluguje <acronym title="Prosty protokól przesylania poczty">SMTP</acronym>, możesz skorzystac z tej funkcji.';
...
$TEXT['ERR_USE_SYSTEM_DEFAULT'] = 'Ustawienie domyślne systemu (php.ini)';
$TEXT['ERR_HIDE_ERRORS_NOTICES'] = 'Nie wyświetlać jakichkolwiek notyfikacji (WWW)';
$TEXT['ERR_SHOW_ERRORS_NOTICES'] = 'Wyświetlać wszelkie notyfikacje (development)';
$TEXT['ERR_SHOW_ERRORS_HIDE_NOTICES'] = 'Wyświetlać errors, nie wyświetlać notices';


$HEADING['ADDON_PRECHECK_FAILED'] = 'Wymagania dodatku nie zostały spełnione';
$HEADING['ADD_CHILD_PAGE'] = 'Dodaj podstronęo"';
...
$HEADING['INVOKE_LANGUAGE_FILES'] = 'Uaktywnij pliki językowe recznie';
$HEADING['INVOKE_MODULE_FILES'] = 'Uaktywnij pliki modułów recznie';
$HEADING['INVOKE_TEMPLATE_FILES'] = 'Uaktywnij pliki szablonów recznie';
$HEADING['LANGUAGE_DETAILS'] = 'Szczególy języka';
$HEADING['MANAGE_SECTIONS'] = 'Zarządzaj sekcjami';
$HEADING['MODIFY_ADVANCED_PAGE_SETTINGS'] = 'Zmień zaawansowane ustawienia strony';
$HEADING['MODIFY_DELETE_GROUP'] = 'Zmień/usun grupę';
$HEADING['MODIFY_DELETE_PAGE'] = 'Zmień/usun stronę';
$HEADING['MODIFY_DELETE_USER'] = 'Zmień/usun użytkownika';
$HEADING['MODIFY_GROUP'] = 'Zmień grupę';
$HEADING['MODIFY_GROUPS'] = 'Zmień grupy';
$HEADING['MODIFY_INTRO_PAGE'] = 'Zmień stronę poczatkowa';
...
$MESSAGE['ADDON_MANUAL_FTP_LANGUAGE'] = '<strong>UWAGA!</strong> Ze wzgledów bezpieczeństwa przesłanie plików językowych do folderu /languages/ powinno odbyć się tylko przez FTP.';
$MESSAGE['ADDON_MANUAL_FTP_WARNING'] = 'Uwaga istniejace wpisy modułu moga zostac utracone w bazie danych.';
$MESSAGE['ADDON_MANUAL_INSTALLATION'] = 'Jesli moduły sa przesylane za pomocą protokolu FTP (nie polecane), to funkcje takie jak <tt>instalacja</tt>, <tt>aktualizacja</tt> lub <tt>odinstalowanie</tt> moga nie dzialac prawidłowo. <br /><br />';
$MESSAGE['ADDON_MANUAL_INSTALLATION_WARNING'] = 'Uwaga istniejace wpisy modułu moga zostac utracone w bazie danych. Uzyj tej opcji tylko wtedy gdy masz problemy z przesłaniem przez FTP.';
...
$MESSAGE['GENERIC_CANNOT_UNINSTALL_IN_USE_TMPL_PAGES'] = 'następujaca strona/następujace strony';
$MESSAGE['GENERIC_CANNOT_UNINSTALL_IS_DEFAULT_TEMPLATE'] = 'Template <b>{{name}}</b> nie może być odinstalowany, ponieważ jest ustawiony jako template domyślny!';
...
$MESSAGE['GENERIC_ERROR_OPENING_FILE'] = 'Bląd podczas otwierania pliku.';
...
$MESSAGE['GENERIC_INVALID_ADDON_FILE'] = 'Nieprawidłowy plik instalacyjny WBCE CMS. Sprawdź format *.zip.';
$MESSAGE['GENERIC_INVALID_LANGUAGE_FILE'] = 'Nieprawidłowy plik językowy WBCE CMS. Proszę sprawdzić w pliku tekstowym.';
$MESSAGE['GENERIC_INVALID_MODULE_FILE'] = 'Nieprawidłowy plik modułu WBCE CMS. Proszę sprawdzić w pliku tekstowym.';
$MESSAGE['GENERIC_INVALID_TEMPLATE_FILE'] = 'Nieprawidłowy plik szablonu WBCE CMS. Proszę sprawdzić w pliku tekstowym.';
...
$MESSAGE['GENERIC_NOT_INSTALLED'] = 'Nie zainstalowano';
...
$MESSAGE['GROUP_HAS_MEMBERS'] = 'Ta grupa zawiera użytkowników.';
...
$MESSAGE['MEDIA_CANNOT_RENAME'] = 'Nie udalo się zmienić nazwy';
$MESSAGE['MEDIA_CONFIRM_DELETE'] = 'Czy aby na pewno usunąć następujace pliki lub foldery?';
...
$MESSAGE['MEDIA_DIR_NOT_MADE'] = 'Nie udalo się utworzyc folderu';
...
$MESSAGE['MOD_FORM_EXCESS_SUBMISSIONS'] = 'Niestety, ten formularz został wysłany zbyt wiele razy w ciagu tej godziny. Prosimy spróbować ponownie za godzine.';
$MESSAGE['MOD_FORM_INCORRECT_CAPTCHA'] = 'Wprowadzony numer weryfikacyjny (tzw. Captcha) jest nieprawidłowy. Jesli masz problemy z odczytaniem Captcha, napisz do: <a href="mailto:{SERVER_EMAIL}">{SERVER_EMAIL}</a>';
$MESSAGE['MOD_FORM_REQUIRED_FIELDS'] = 'Należy wprowadzić szczególy dla następujacych pól';
$MESSAGE['PAGES_ADDED'] = 'Strona została dodana';
$MESSAGE['PAGES_ADDED_HEADING'] = 'Naglówek strony został dodany';
$MESSAGE['PAGES_BLANK_MENU_TITLE'] = 'Proszę wprowadzić tytuł menu';
$MESSAGE['PAGES_BLANK_PAGE_TITLE'] = 'Proszę wprowadzić tytuł strony';
$MESSAGE['PAGES_CANNOT_CREATE_ACCESS_FILE'] = 'Bląd podczas tworzenia pliku dostępowego w katalogu /pages (niewystarczające uprawnienia)';
$MESSAGE['PAGES_CANNOT_DELETE_ACCESS_FILE'] = 'Bląd podczas usuwania pliku dostępowego w katalogu /pages (niewystarczające uprawnienia)';
$MESSAGE['PAGES_CANNOT_REORDER'] = 'Bląd podczas zmieniania kolejnośći stron';
...
$MESSAGE['PREFERENCES_CURRENT_PASSWORD_INCORRECT'] = 'Podane hasło jest nieprawidłowe. <br /><b>Dane muszą być potwierdzone bieżącym hasłem</b>';
$MESSAGE['PREFERENCES_DETAILS_SAVED'] = 'Szczególy zostały zapisane';
...
$MESSAGE['SETTINGS_WORLD_WRITEABLE_WARNING'] = 'Uwaga: zalecane wyłącznie w srodowiskach testowych';
...
Prosba:
Jesli otrzymales te wiadomość przez pomylke, usun ja niezwlocznie!
-------------------------------------
Ta wiadomość została wygenerowana automatycznie&#33;&#10;';
...
$MESSAGE['TEMPLATES_CHANGE_TEMPLATE_NOTICE'] = 'Uwaga: aby zmienić szablon, nalezy przejsc do sekcji Ustawienia';
$MESSAGE['UPLOAD_ERR_OK'] = 'Wysłanie pliku/plików powiodło się';
$MESSAGE['UPLOAD_ERR_INI_SIZE'] = 'The uploaded file exceeds the upload_max_filesize directive in php.ini';
$MESSAGE['UPLOAD_ERR_FORM_SIZE'] = 'The uploaded file exceeds the MAX_FILE_SIZE directive that was specified in the HTML form';
$MESSAGE['UPLOAD_ERR_PARTIAL'] = 'The uploaded file was only partially uploaded';
$MESSAGE['UPLOAD_ERR_NO_FILE'] = 'No file was uploaded';
$MESSAGE['UPLOAD_ERR_NO_TMP_DIR'] = 'Folder /temp/ nie został odnaleziony';
$MESSAGE['UPLOAD_ERR_CANT_WRITE'] = 'Zapisanie pliku ba serwerze nie powiodło się';
$MESSAGE['UPLOAD_ERR_EXTENSION'] = 'File upload stopped by extension';
$MESSAGE['UNKNOW_UPLOAD_ERROR'] = 'Nieoczekiwany błąd';
$MESSAGE['USERS_ADDED'] = 'Użytkownik został dodany';
$MESSAGE['USERS_CANT_SELFDELETE'] = 'Zadanie odrzucone, Nie możesz usunąć sam siebie!';
$MESSAGE['USERS_CHANGING_PASSWORD'] = 'Uwaga: Powyższe pola należy wypełnić tylko, jeśli ma być zmienione hasło';
...
$MESSAGE['USERS_PASSWORD_MISMATCH'] = 'Wprowadzone hasła nie pasuja';
$MESSAGE['USERS_PASSWORD_TOO_SHORT'] = 'Wprowadzone hasło było za krótkie';
$MESSAGE['USERS_SAVED'] = 'Użytkownik został zapisany';
$MESSAGE['USERS_USERNAME_TAKEN'] = 'Wprowadzona nazwa użytkownika już istnieje';
$MESSAGE['USERS_USERNAME_TOO_SHORT'] = 'Wprowadzona nazwa użytkownika była za krótkie';


$OVERVIEW['ADMINTOOLS'] = 'Narzędzia administracji WBCE CMS...';

...
$TEXT['INTRO'] = 'Eingangs';
$TEXT['INTRO_PAGE'] = 'Vorschaltseite (sofern vorhanden)';
...
$TEXT['WBMAILER_DEFAULT_SETTINGS_NOTICE'] = 'Bitte geben Sie eine Standard-Absenderadresse und einen Absendernamen an. Als Absender-E-Mail-Adresse empfiehlt sich ein Format wie: <strong>admin@ihredomain.tld</strong>. Manche E-Mail-Provider (z.B. <em>mail.de</em>) stellen keine E-Mails zu, die nicht &#252;ber den Provider selbst verschickt wurden, in der Absenderadresse aber den Namen des E-Mail-Providers <em>name@mail.de</em> enthalten. Die Standardwerte werden nur verwendet, wenn keine anderen Werte von WebsiteBaker CE bzw. installierten Modulen gesetzt wurden. Wenn Ihr Webspaceprovider <acronym title="Simple Mail Transfer Protocol">SMTP</acronym> anbietet, sollten Sie diese Option f&#252;r ausgehende E-Mails verwenden.';
...
$MESSAGE['GENERIC_CANNOT_UNINSTALL'] = 'Deinstallation fehlgeschlagen oder nicht zul&#228;ssig';

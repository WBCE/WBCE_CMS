...
$language_code = 'NO';
$language_name = 'Norsk Bokmål'; // 'Norwegian';
...
$TEXT['BACKUP_WB_SPECIFIC'] = 'Sikkerhetskopiere bare WBCE- spesifikke tabeller';
...
$TEXT['DEFAULT_CHARSET'] = 'Standard tegnsett';
$TEXT['DEFAULT_TEXT'] = 'Standard Tekst';
$TEXT['DELETE'] = 'Slett';
$TEXT['DELETED'] = 'Slettet';
$TEXT['DELETE_DATE'] = 'Slette dato';
$TEXT['DELETE_ZIP'] = 'Slett .zip arkivet etter at det er pakket ut';
...
$TEXT['HOME_FOLDER'] = 'Personelig Folder';
$TEXT['HOME_FOLDERS'] = 'Personelig Foldere';
$TEXT['HOST'] = 'Vert';
$TEXT['ICON'] = 'Ikon';
$TEXT['IMAGE'] = 'Bilde';
$TEXT['INLINE'] = 'In-line';
...
$TEXT['MENU'] = 'Meny';
$TEXT['FILENAME'] = 'Filenavn';
$TEXT['MENU_ICON_0'] = 'Meny-Ikon normal';
$TEXT['MENU_ICON_1'] = 'Meny-Ikon svevende';
...
$TEXT['NO_IMAGE_SELECTED'] = 'bilde ikke valgt';
...
$TEXT['PAGES_PERMISSION'] = 'Side rettighet';
$TEXT['PAGES_PERMISSIONS'] = 'Side rettigheter';
$TEXT['PAGE_EXTENSION'] = 'Side Tillegg';
$TEXT['PAGE_ICON'] = 'Side Bilde';
$TEXT['PAGE_ICON_DIR'] = 'Sti til side/meny bilder';
...
$TEXT['RENAME_FILES_ON_UPLOAD'] = 'Opplasting av denne filtypen støttes ikke';
...
$TEXT['SERVER_OPERATING_SYSTEM'] = 'Serverens Operativsystem';
...
$TEXT['THEME'] = 'Designmal For Admin. sidene';
$TEXT['TIME'] = 'Tid';
...
$TEXT['USERS_ACTIVE'] = 'Bruker er nå aktivert';
$TEXT['USERS_CAN_SELFDELETE'] = 'Brukeren kan slette seg selv';
$TEXT['USERS_CHANGE_SETTINGS'] = 'Brukeren kan endre innstillingene sine selv';
$TEXT['USERS_DELETED'] = 'Brukeren er merket som slettet';
$TEXT['USERS_FLAGS'] = 'Brukerflagg';
$TEXT['USERS_PROFILE_ALLOWED'] = 'Beukeren kan opprette utvidet profil';
...
$TEXT['YES'] = 'Ja';
$TEXT['ADVANCED_SEARCH'] = 'Avanset søk';
$TEXT['QUICK_SEARCH_STRG_F'] = 'Trykk <b>Ctrl + f</b> for hurtigsøk, eller bruk';
$TEXT['THEME_COPY_CURRENT'] = 'Lag kopi av admin. sidenes designmal';
$TEXT['THEME_NEW_NAME'] = 'Navn på ny designmal';
$TEXT['THEME_CURRENT'] = 'nåværende aktive designmal';
$TEXT['THEME_START_COPY'] = 'kopier';
$TEXT['THEME_IMPORT_HTT'] = 'Importer flere designamler';
$TEXT['THEME_SELECT_HTT'] = 'velg designmal';
$TEXT['THEME_NOMORE_HTT'] = 'ingen flere tilgjengelige';
$TEXT['THEME_START_IMPORT'] = 'importer';
//PHP feilniå (fra og med WBCE 1.3.0) // PHP error levels (since WBCE 1.3.0)
$TEXT['ERR_USE_SYSTEM_DEFAULT'] = 'Bruk systemets standard (php.ini)';
$TEXT['ERR_HIDE_ERRORS_NOTICES'] = 'Skjul alle feil og varsler (WWW)';
$TEXT['ERR_SHOW_ERRORS_NOTICES'] = 'Vis alle feil og varsler (utvikling)';
$TEXT['ERR_SHOW_ERRORS_HIDE_NOTICES'] = 'Vis feil, skjul varsler';
...
$HEADING['INVOKE_LANGUAGE_FILES'] = 'Aktiver språkfilen manuelt';
$HEADING['INVOKE_MODULE_FILES'] = 'Aktiver modul filene mauelt';
$HEADING['INVOKE_TEMPLATE_FILES'] = 'Aktiver designmalen manuelt';
...
$MESSAGE['ADDON_ERROR_RELOAD'] = 'Feil under oppdatering av tilleggsmodulen';
$MESSAGE['ADDON_LANGUAGES_RELOADED'] = 'Vellykket reaktivering av språkfilen';
$MESSAGE['ADDON_MANUAL_FTP_LANGUAGE'] = '<strong>OBS!</strong> Av sikkerhestmessige årsaker, kan språkfiler kun lates opp med FTP til mappen "/languages". Bruk så oppdateringsfunksjonen for å registere eller oppdatere språkfilen.'; // '<strong>ATTENTION!</strong> For safety reasons uploading languages files in the folder/languages/ only by FTP and use the Upgrade function for registering or updating.';
$MESSAGE['ADDON_MANUAL_FTP_WARNING'] = '<strong>ADVARSEL:</strong> Alle dataene i eksisterende moduldatabase vil bli stettet';
$MESSAGE['ADDON_MANUAL_INSTALLATION'] = 'Når tilleggsmoduler lastes opp med FTP (anbefales ikke), vil ikke de automatiske funksjonene <code>install</code>, <code>oppgrader</code> or <code>avinnstaller</code> kjøres. Dette kan føre til att disse modulene ikke virker ordentlig.<br /><br />Nedenfor kan du aktivere disse modulene manult.'; // 'When modules are uploaded via FTP (not recommended), the module installation functions <code>install</code>, <code>upgrade</code> or <code>uninstall</code> will not be executed automatically. Those modules may not work correct or do not uninstall properly.<br /><br />You can execute the module functions manually for modules uploaded via FTP below.';
$MESSAGE['ADDON_MANUAL_INSTALLATION_WARNING'] = '<strong>ADVARSEL:</strong> Alle dataene i eksisterende moduldatabase vil bli stettet. Bruk denne funksjonen bare på tilleggsmoduler som er latet opp med FTP'; // 'Warning: Existing module database entries will get lost. Only use this option if you experience problems with modules uploaded via FTP.';
$MESSAGE['ADDON_MANUAL_RELOAD_WARNING'] ='<strong>ADVARSEL:</strong> Alle dataene i eksisterende moduldatabase vil bli stettet';
$MESSAGE['ADDON_MODULES_RELOADED'] = 'Tilleggsmodulene blei lastet på nytt';
$MESSAGE['ADDON_OVERWRITE_NEWER_FILES'] = 'Overskriv nyere Filer';
$MESSAGE['ADDON_PRECHECK_FAILED'] = 'Tilleggsmodueln kunne ikke installeres. Sytemet ditt tilfredsstiller ikke krevene til denne tilleggsmodulen. For att tilleggsmodulen skal fungere på systemet ditt, må du rette opp feilene som er listet opp nedenfor.'; // 'Add-on installation failed. Your system does not fulfill the requirements of this Add-on. To make this Add-on working on your system, please fix the issues summarized below.';
$MESSAGE['ADDON_RELOAD'] = 'Oppdater databasen med innformnasjonen fra tillegsmodulene (f. eks etter opplating aav tillegsmoduler med FTP)';
$MESSAGE['ADDON_TEMPLATES_RELOADED'] = 'Designmalene blei lastet på nytt';
$MESSAGE['ADMIN_INSUFFICIENT_PRIVELLIGES'] = 'Mangelfull tillgangsrettigheter';
...
$MESSAGE['FORGOT_PASS_PASSWORD_RESET'] = 'Innloggingsdetajene dine r sendt til deg på e-postadressen din';
...
$MESSAGE['GENERIC_BE_PATIENT'] = 'Venligst vent';
...
$MESSAGE['GENERIC_FAILED_COMPARE'] = 'feilet';
$MESSAGE['GENERIC_FILE_TYPE'] = 'OBS! filen du vil laste opp må være av følgende format:';
$MESSAGE['GENERIC_FILE_TYPES'] = 'OBS! filen du vil laste opp må være en av følgende formater:';
$MESSAGE['GENERIC_FILL_IN_ALL'] = 'Vennligst gå tilbake og fyll inn alle felter';
$MESSAGE['GENERIC_FORGOT_OPTIONS'] = 'Du har ikke gjort noen valg!';
$MESSAGE['GENERIC_INSTALLED'] = 'Lykkes å installere';
$MESSAGE['GENERIC_INVALID'] = 'Filen du lastet opp er ikke gyldig';
$MESSAGE['GENERIC_INVALID_ADDON_FILE'] = 'Feil i WBCE CMS installasjonsfilen. Vennligst sjekk formatet å *.zip filen.';
$MESSAGE['GENERIC_INVALID_LANGUAGE_FILE'] = 'Feil i WBCE CMS språkfilen. Vennligst sjekk tekst filen.';
$MESSAGE['GENERIC_INVALID_MODULE_FILE'] = 'Feil i WBCE CMS tilleggsmodulfilen. Sjekk tekstfilen';
$MESSAGE['GENERIC_INVALID_TEMPLATE_FILE'] = 'Ugyldig WBCE CMS designmalen. Sjekk tekstfilen';
$MESSAGE['GENERIC_IN_USE'] = 'men benyttet i ';
$MESSAGE['GENERIC_MISSING_ARCHIVE_FILE'] = 'Manglende Arkivfil!';
$MESSAGE['GENERIC_MODULE_VERSION_ERROR'] = 'Tilleggsmodulen er ikke korrekt installert!';
$MESSAGE['GENERIC_NOT_COMPARE'] = ' ikke mulig';
$MESSAGE['GENERIC_NOT_INSTALLED'] = 'Ikke installert';
$MESSAGE['GENERIC_NOT_UPGRADED'] = 'Aktivering ikke mulig';
...
$MESSAGE['GENERIC_SECURITY_ACCESS'] = 'Sikkerhetsbrudd!! Tillgang nektet!';
...
$MESSAGE['GENERIC_VERSION_COMPARE'] = 'Versjonssammenling';
$MESSAGE['GENERIC_VERSION_GT'] = 'Oppgraderigner påkrevet';
$MESSAGE['GENERIC_VERSION_LT'] = 'Nedgrader';
$MESSAGE['GENERIC_WEBSITE_UNDER_CONSTRUCTION'] = 'Nettstedet er under konstruksjon';
$MESSAGE['GENERIC_WEBSITE_LOCKED'] = 'Nettstedet er midlertidig nede for vedlikehold';
$MESSAGE['GROUP_HAS_MEMBERS'] = 'Denne gruppen har fortsatt medlemmer';
...
$MESSAGE['LOGIN_BOTH_BLANK'] = 'Logg inn med brukernavn og passord nedenfor';
...
$MESSAGE['LOGIN_USERNAME_BLANK'] = 'Venligst skriv inn brikernavn';
$MESSAGE['LOGIN_USERNAME_TOO_LONG'] = 'Inntastet brukernavn er for langt';
$MESSAGE['LOGIN_USERNAME_TOO_SHORT'] = 'Inntastet brukernavn er for kort';
$MESSAGE['MEDIA_BLANK_EXTENSION'] = 'Du anga ikke inn en filtype';
...
$MESSAGE['MEDIA_DIR_ACCESS_DENIED'] = 'Mappen du anga eksisterer ikke, eller du mangler tilgang';
...
$MESSAGE['MEDIA_NO_FILE_UPLOADED'] = 'Mottok ingen fil';
...
$MESSAGE['SETTINGS_WORLD_WRITEABLE_WARNING'] = 'Merk: Dette er kun ment for testmiljøer';
...
$MESSAGE['START_UPGRADE_SCRIPT_EXISTS'] = 'Venligst slett "upgrade-script.php" filen fra webserveren din';
...
$MESSAGE['UPLOAD_ERR_OK'] = 'Fielen blei lastet opp';
$MESSAGE['UPLOAD_ERR_INI_SIZE'] = 'Filen overskrider maksimalt tillat filstørrelse';
$MESSAGE['UPLOAD_ERR_FORM_SIZE'] = 'Opplastet fil overskrider MAX_FILE_SIZE angitt i HTML skjemaet';
$MESSAGE['UPLOAD_ERR_PARTIAL'] = 'Filen blei bare delvis opplastet';
$MESSAGE['UPLOAD_ERR_NO_FILE'] = 'Det blei ikke lastet opp noen fil';
$MESSAGE['UPLOAD_ERR_NO_TMP_DIR'] = 'Mangler en milertidig forlder';
$MESSAGE['UPLOAD_ERR_CANT_WRITE'] = 'Kunne ikke lagre filen. Manglende rettigheter';
$MESSAGE['UPLOAD_ERR_EXTENSION'] = 'Feil filtype';
$MESSAGE['UNKNOW_UPLOAD_ERROR'] = 'Ukjent feil med opplastingen';
$MESSAGE['USERS_ADDED'] = 'Lykkes å opprette ny bruker';
$MESSAGE['USERS_CANT_SELFDELETE'] = 'Handlingen ble avbrutt. Du kan ikke slette deg selv!';
...
$MESSAGE['USERS_NAME_INVALID_CHARS'] = 'Ugyldige tegn i Brukernavnet';
...
$MESSAGE['USERS_USERNAME_TAKEN'] = 'Brukernqavent eksisterer allerede';
$MESSAGE['USERS_USERNAME_TOO_SHORT'] = 'Brukernavent er for kort';
$MESSAGE['THEME_COPY_CURRENT'] = 'Kopier eksisterende designmal, og lagre med nytt navn';
$MESSAGE['THEME_ALREADY_EXISTS'] = 'Designmalnavnet eksisterer allerede';
$MESSAGE['THEME_INVALID_SOURCE_DESTINATION'] = 'Feil i beskrivelsen for den nye designmalen';
$MESSAGE['THEME_DESTINATION_READONLY'] = 'Mangler rerettigheter for å opprette mappe for designmalen';
$MESSAGE['THEME_IMPORT_HTT'] = 'Importer yttligere designamler inn i det gjeldende desigent. <br />Bruk denne designmalen for å overskrive standard designmal';

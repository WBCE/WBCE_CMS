...
$TXT['btn_check_settings']   = 'It seems WBCE CMS is already installed.';
...
$TXT['upgrade_warning']         = 'The update script modifies the existing database and file structure. It is <strong>strongly recommended</strong> to create a full backup of files and the entire database before proceeding.';
$TXT['upgrade_confirm']         = 'I confirm that I have created a full backup of files and the database.';
...
$TXT['wbce_seems_installed']    = "WBCE CMS seems to be already installed.";

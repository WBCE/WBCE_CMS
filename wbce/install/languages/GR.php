...
$TXT['step3_desc']           = 'Εισήγαγε τα στοιχεία σύνδεσης της βάσης δεδομένων';
...
$TXT['upgrade_warning']         = 'Το script ενημέρωσης τροποποιεί την υπάρχουσα βάση δεδομένων και δομή αρχείων. <strong>Συνιστάται ανεπιφύλακτα</strong> να δημιουργήσετε πλήρες αντίγραφο ασφαλείας των αρχείων και ολόκληρης της βάσης δεδομένων πριν συνεχίσετε.';

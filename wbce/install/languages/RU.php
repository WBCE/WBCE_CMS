...
$TXT['step3_desc']           = 'Введи данные для подключения к базе данных';
...
$TXT['upgrade_warning']         = 'Скрипт обновления изменяет существующую базу данных и структуру файлов. <strong>Настоятельно рекомендуется</strong> создать полную резервную копию файлов и всей базы данных перед продолжением.';

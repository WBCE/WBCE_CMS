...
$TXT['step3_desc']           = 'Въведи данните си за връзка с базата данни';
...
$TXT['upgrade_warning']         = 'Скриптът за актуализация модифицира съществуващата база данни и файловата структура. <strong>Силно се препоръчва</strong> да се създаде пълно резервно копие на файловете и цялата база данни преди да продължите.';

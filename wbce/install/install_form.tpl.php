            ...
            <table class="step2">
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="value">
                            <input <?php echo field_error('website_title');?> type="text" tabindex="1" name="website_title" style="width: 72%;" value="<?php echo $sWebsiteTitle  ?>" />
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="value">
                            ...
                            <input <?php echo field_error('wb_url');?> type="text" tabindex="2" name="wb_url" style="width: 72%;" value="<?php echo $sWbUrl ?>" />
                        </td>
                        <td colspan="4">&nbsp;</td>
                    </tr>
                    <tr>
                        ...
                        <td class="value">
                            <select <?php echo field_error('default_timezone');?> tabindex="3" name="default_timezone" style="width: 75%;">
                    ...
                    <tr>
                        ...
                        <td class="value">
                            <select <?php echo field_error('default_language');?> tabindex="4" name="default_language" style="width: 75%;">
                    ...
                    <tr>
                        ...
                        <td >
                            <input type="radio" tabindex="5" name="operating_system" id="operating_system_linux" onclick="document.getElementById('file_perms_box').style.display = 'none';" value="linux"<?php echo $sLinux ?> />

...
-- new cols since 1.7.0 (core, updated_when, updated_by)
  ...
  `updated_when` INT          NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS `{TP}sections` (
  ...
  `publ_end`      INT          NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS `{TP}users` (
  ...
  `gdpr_check`         TINYINT(1)   NOT NULL DEFAULT 0,
  ...
  `signup_timestamp`   INT          NOT NULL DEFAULT 0,
  `signup_timeout`     INT          NOT NULL DEFAULT 0,

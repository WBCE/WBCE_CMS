...
?>
  <table>
   ...
   <tbody>
    ...
    <tr>
     <td colspan="6" class="error"><b>Please note:</b> PHP Session Support may appear disabled if your browser does not support cookies.</td>
    </tr>
    <?php }
?>
    <tr>
...
if ($chrval == false) {
    ...
    ?>
      <span class="bad"><?php echo $e_adc?></span>
      <?php
}
...
?></td>
    ...
    ?>
    <tr>
     <td colspan="6"><p class="warning"> <b>Please note:</b> Yor webserver is configured to deliver <b><?php echo $e_adc;?></b> charset only.<br />
       ...
       But this solution does not guarranty a correct displaying of the content from all modules! </p></td>
    </tr>
    <?php }
?>
   </tbody>
  ...
  <table>
   ...
   <tbody>
    <tr>
     ...
     <td style=""><input type="radio" tabindex="4" name="operating_system" id="operating_system_linux" onclick="document.getElementById('file_perms_box').style.display = 'none';" value="linux"<?php if (!isset($_SESSION['operating_system']) or $_SESSION['operating_system'] == 'linux') {echo ' checked="checked"';}
    ?> />
    ...
    <tr>
     <td class="name">&nbsp;</td>
     <td class="value"><div id="file_perms_box" style="line-height:2em; position: relative; width: 100%;float:left; margin: 0; padding: 0; display: <?php if (isset($_SESSION['operating_system']) and $_SESSION['operating_system'] == 'windows') {echo 'none';} else {echo 'none';}
    ?>;">
  ...
  <table>
   ...
   <tbody>
    <tr>
     ...
     <td class="value"><input <?php echo field_error('database_host');?> type="text" tabindex="7" name="database_host" value="<?php if (isset($_SESSION['database_host'])) {echo $_SESSION['database_host'];} else {echo 'localhost';}
    ?>" /></td>
    </tr>
    <tr>
     <td class="name">Database Name: </td>
     <td class="value"><input <?php echo field_error('database_name')?> type="text" tabindex="8" name="database_name" value="<?php if (isset($_SESSION['database_name'])) {echo $_SESSION['database_name'];} else {echo 'DatabaseName';}
    ?>" />
      <span style="display: inline;">&nbsp;([a-zA-Z0-9_-])</span></td>
    </tr>
    <tr>
     <td class="name">Table Prefix: </td>
     <td class="value"><input <?php echo field_error('table_prefix')?> type="text" tabindex="9" name="table_prefix" value="<?php if (isset($_SESSION['table_prefix'])) {echo $_SESSION['table_prefix'];} else {echo 'wbce_';}
    ?>" />
      <span style="display: inline;">&nbsp;([a-zA-Z0-9_])</span></td>
    </tr>
    <tr>
     <td class="name">Username:</td>
     <td class="value"><input <?php echo field_error('database_username');?> type="text" tabindex="10" name="database_username" value="<?php if (isset($_SESSION['database_username'])) {echo $_SESSION['database_username'];} else {echo 'root';}
    ?>" /></td>
    </tr>
    <tr>
     <td class="name">Password:</td>
     <td class="value"><input type="password" tabindex="11" name="database_password" value="<?php if (isset($_SESSION['database_password'])) {echo $_SESSION['database_password'];}
    ?>" /></td>
    </tr>
    <tr>
  ...
  <table>
   ...
   <tbody>
    <tr>
     ...
     <td class="value"><input <?php echo field_error('website_title');?> type="text" tabindex="13" name="website_title" value="<?php if (isset($_SESSION['website_title'])) {echo $_SESSION['website_title'];} else {echo 'Enter your website title';}
    ?>" /></td>
    </tr>
   </tbody>
  </table>
  <table>
   ...
   <tbody>
    <tr>
     ...
     <td class="value"><input <?php echo field_error('admin_username');?> type="text" tabindex="14" name="admin_username" value="<?php if (isset($_SESSION['admin_username'])) {echo $_SESSION['admin_username'];} else {echo 'admin';}
    ?>" /></td>
    </tr>
    <tr>
     <td class="name">Email:</td>
     <td class="value"><input <?php echo field_error('admin_email');?> type="text" tabindex="15" name="admin_email" value="<?php if (isset($_SESSION['admin_email'])) {echo $_SESSION['admin_email'];}
    ?>" /></td>
    </tr>
    <tr>
     <td class="name">Password:</td>
     <td class="value"><input <?php echo field_error('admin_password');?> type="password" tabindex="16" name="admin_password" value="" /></td>
    </tr>
    <tr>
     <td class="name">Re-Password:</td>
     <td class="value"><input <?php echo field_error('admin_repassword');?> type="password" tabindex="17" name="admin_repassword" value=""  /></td>
    </tr>
   </tbody>
  </table>
  <?php }
